...
import { HomeContainer, ParaTitle, ParaSubtitle, ParaText, TransparentLeft, TransparentRight } from "./HomeSC";
...
export function Home() {
  return (
    <HomeContainer>
      <Carousel />
      {/* <TransparentArea></TransparentArea> */}
    </HomeContainer>
  );
}
...
function Carousel() {
  ...
  return (
    <div style={{ position: "relative" }}>
      <Swiper
        modules={[Navigation, Pagination, Scrollbar, A11y, EffectFade, Autoplay, Parallax]}
        effect="fade"
        parallax={true}
        spaceBetween={30}
        slidesPerView={1}
        ...
        {threads.map((thread) => {
          return (
            ...
            >
              ...
              <ParaText className="text" data-swiper-parallax="-200" data-swiper-parallax-duration="300">
                <p>NEW</p>
              </ParaText>
            </SwiperSlide>
          );
